...
class TreeESIM(nn.Module):
    ...
    def __init__(self, num_units, num_classes, embedding_size, dropout, device=0,
        ...
        self.linear_layer_aggregate = nn.Sequential(nn.Dropout(p=dropout), nn.Linear(4*num_units, num_units), nn.ReLU(),
