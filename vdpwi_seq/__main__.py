...
def evaluate_dataset(split_name, dataset_cls, model, embedding, loader, batch_size, device, run_label, result_loc, dataset):
    ...
    # file = open("result_file/" + run_label, "a+")
    file = open(result_loc + run_label, "a+")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sparse-features', action='store_true', default=False,
    ...
    parser.add_argument('--optimizer', type=str, default='rmsprop',
                        help='optimizer to use: adam, sgd, or rmsprop (default: adam)')
    ...
    parser.add_argument('--regularization', type=float, default=1E-5,
                        help='Regularization for the optimizer (default: 0.00001)')
    ...
    if dev_loader:
        evaluate_dataset('dev', dataset_cls, model, embedding, dev_loader, args.batch_size, args.device, args.fileID,
                         args.resultLoc, args.dataset)
    evaluate_dataset('test', dataset_cls, model, embedding, test_loader, args.batch_size, args.device, args.fileID,
                     args.resultLoc, args.dataset)